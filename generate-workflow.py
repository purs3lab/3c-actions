...
HEADER = '''\
# This file is generated by generate-exhaustive-workflow.py. To update this file, update
# generate-exhaustive-workflow.py instead and re-run it. Some things in this file are
# explained by comments in generate-exhaustive-workflow.py.
...
Format:
  {
    workflow_file_path : (<run_config>, [True|False] <- flag to enable stats generation)
  }
'''
workflow_file_configs = {
    '.github/workflows/main.yml': (regular_run_configurations, False),
    '.github/workflows/exhaustive.yml': (exhaustive_run_configurations, True)
}

for workflow_file in workflow_file_configs:
    run_configurations = workflow_file_configs[workflow_file][0]
    generate_stats = workflow_file_configs[workflow_file][1]
